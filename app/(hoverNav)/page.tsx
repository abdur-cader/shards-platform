...
export default function Home() {
  ...
  const faqData = [
  {
    ...
    answer: "Shards is a platform where developers can showcase projects, explore what others are building, and get AI-powered insights on their work."
  },
  {
    question: "Who can use Shards?",
    answer: "Anyone who codes or builds projects—beginners, students, and pros alike."
  },
  {
    question: "Do I need a GitHub account?",
    answer: "Yes, you need a GitHub account to sign in and submit your projects to Shards."
  },
  {
    question: "Do I need to pay to use Shards?",
    answer: "No, Shards is free to use for showcasing projects and using the AI toolkit."
  },
  {
    question: "How does the AI toolkit work?",
    answer: "Submit your project to get AI-powered insights and suggestions on your code or project structure."
  },
  {
    question: "Is my code private when I upload it?",
    answer: "Yes, you can choose to keep projects private or share them publicly while still using AI insights."
  },
  {
    question: "Can I see other people's projects?",
    answer: "Absolutely! Browsing other projects is a key way to discover inspiration and learn from examples."
  },
  {
    question: "What kind of projects can I share?",
    answer: "Any coding or development project—web apps, scripts, experiments, libraries, or anything you've built!"
  },
  {
    question: "How do I get started?",
    answer: "Sign in with GitHub, upload a project, and explore the gallery. Then use the AI toolkit for insights."
  }
];
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <FadeInOnScroll>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
              <InfoCard
                svg={<Braces className="text-purple-200 group-hover:text-purple-100" size={32} />}
              ...
              <InfoCard
                svg={<MessageCircleCode className="text-purple-200 group-hover:text-purple-100" size={32} />}
              ...
              <InfoCard
                svg={<TrendingUp className="text-purple-200 group-hover:text-purple-100" size={32} />}
              ...
              <InfoCard
                svg={<Search className="text-purple-200 group-hover:text-purple-100" size={32} />}
          ...
          <FadeInOnScroll>
  <div className="flex flex-col md:flex-row items-center gap-8 mb-15 relative"> {/* Reduced gap from 12 to 8 */}
    <div className="md:w-4/5 relative md:left-[-30%] w-[180%]"> {/* Adjusted left to -30%, increased width to 180% */}
    ...
    <div className="md:w-1/2 md:pr-8 md:ml-[-10%]"> {/* Added negative margin to pull text closer */}
      <h3 className="text-2xl font-[500] mb-4 text-foreground dark:text-foreground">Turn repositories into portfolio pieces</h3>
...
<FadeInOnScroll>
  <div className="flex flex-col md:flex-row items-center gap-8 mb-28 relative"> {/* Reduced gap from 12 to 8 */}
    <div className="md:w-1/2 order-2 md:order-1 md:pl-8 md:mr-[-10%] z-10"> {/* Added negative margin and z-index */}
      <h3 className="text-2xl font-[500] mb-4 text-foreground dark:text-foreground">Get AI-powered code insights</h3>
      <p className="text-gray-600 dark:text-gray-600 mb-6">
    ...
    <div className="md:w-4/5 relative order-1 md:order-2 md:right-[-30%] w-[180%]"> {/* Adjusted right to -30%, increased width to 180% */}
...
<FadeInOnScroll>
  <div className="flex flex-col md:flex-row items-center gap-8 relative"> {/* Reduced gap from 12 to 8 */}
    <div className="md:w-4/5 relative md:left-[-30%] w-[180%]"> {/* Adjusted left to -30%, increased width to 180% */}
      <div className="w-full aspect-video bg-gradient-to-br from-lime-400 to-emerald-400 dark:from-theme-primary dark:to-emerald-400 rounded-2xl shadow-xl overflow-hidden">
        <div className="absolute inset-0 bg-white rounded-lg flex items-center justify-center p-2">
          <img 
    ...
    <div className="md:w-1/2 md:pr-8 md:ml-[-10%]"> {/* Added negative margin to pull text closer */}
      <h3 className="text-2xl font-[500] mb-4 text-foreground dark:text-foreground">Join a community of builders</h3>
      <p className="text-gray-600 dark:text-gray-600 mb-6">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <FadeInOnScroll>
            <div className="text-center mb-16">
              <h2 className="text-4xl font-[500] mb-4 text-gray-900 dark:text-purple-50">Who Shards Is For</h2>
          ...
          <FadeInOnScroll>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-60">
              <div>
                <h3 className="text-3xl font-[500] mb-6 text-gray-900 dark:text-purple-50">(TL;DR: it's for anyone who wants up their dev game)</h3>
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    <div className="bg-white shadow-md p-3 rounded-full mr-4 border border-gray-200 dark:bg-[#13082d] dark:shadow-purple-700/20 dark:border-purple-800/30">
                      <TrendingUp className="text-lime-600 dark:text-purple-200" size={20} />
                    </div>
                    <div>
                      <h4 className="font-medium text-gray-900 dark:text-purple-50">Aspiring junior developers</h4>
                      <p className="text-gray-600 dark:text-purple-200 text-sm">Stand out in job applications with a polished portfolio</p>
                    </div>
                  </div>
                  
                  <div className="flex items-start">
                    <div className="bg-white shadow-md p-3 rounded-full mr-4 border border-gray-200 dark:bg-[#13082d] dark:shadow-purple-700/20 dark:border-purple-800/30">
                      <Github className="text-lime-600 dark:text-purple-200" size={20} />
                    </div>
                    <div>
                      <h4 className="font-medium text-gray-900 dark:text-purple-50">Open-source contributors</h4>
                      <p className="text-gray-600 dark:text-purple-200 text-sm">Get fresh perspectives on your projects</p>
                    </div>
                  </div>
                  
                  <div className="flex items-start">
                    <div className="bg-white shadow-md p-3 rounded-full mr-4 border border-gray-200 dark:bg-[#13082d] dark:shadow-purple-700/20 dark:border-purple-800/30">
                      <Zap className="text-lime-600 dark:text-purple-200" size={20} />
                    </div>
                    <div>
                      <h4 className="font-medium text-gray-900 dark:text-purple-50">Side project warriors</h4>
                      <p className="text-gray-600 dark:text-purple-200 text-sm">Level up your code quality with AI insights</p>
                    </div>
                  </div>
                  
                  <div className="flex items-start">
                    <div className="bg-white shadow-md p-3 rounded-full mr-4 border border-gray-200 dark:bg-[#13082d] dark:shadow-purple-700/20 dark:border-purple-800/30">
                      <Heart className="text-lime-600 dark:text-purple-200" size={20} />
                    </div>
                    <div>
                      <h4 className="font-medium text-gray-900 dark:text-purple-50">Lifelong learners</h4>
                      <p className="text-gray-600 dark:text-purple-200 text-sm">Grow with every commit and code review</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="">
                <div className="bg-white shadow-lg rounded-xl p-6 mb-6 border border-gray-200 dark:bg-gradient-to-br dark:from-[#13082d] dark:to-[#0f0524] dark:shadow-purple-800/20 dark:border-purple-700/40">
                  <h4 className="font-medium text-gray-900 dark:text-purple-50 mb-3">Not sure if Shards is for you?</h4>
                ...
                <div className="bg-gradient-to-r from-lime-50 to-indigo-50 dark:from-[#160a33] dark:to-[#13082d] rounded-xl p-6 text-gray-900 dark:text-white shadow-lg border border-gray-200 dark:shadow-purple-800/20 dark:border-purple-700/40">
                  ...
                  <div className="flex items-center">
                    <Sparkles size={18} className="mr-2 text-lime-600 dark:text-purple-200" />
          ...
          <FadeInOnScroll>
            <div className="text-center mb-30">
              <h2 className="text-6xl font-[550] mb-10">
                <span className="relative inline-flex items-center text-transparent bg-clip-text 
                                bg-gradient-to-r 
          ...
          <FadeInOnScroll>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
              ...
              <FeatureCard
                icon={<Code className="text-lime-600 dark:text-purple-200" size={20} />}
              ...
              <FeatureCard
                icon={<Sparkles className="text-lime-600 dark:text-purple-200" size={20} />}
                title="Competitive Edge"
                description="Discover what makes your project stand out — get AI-driven insights into its unique value proposition."
              />

              <FeatureCard
                icon={<Lightbulb className="text-lime-600 dark:text-purple-200" size={20} />}
        ...
        <div className="max-w-3xl font-prompt mx-auto px-6 relative z-10">
          <FadeInOnScroll>
            <div className="text-center">
              <h3 className="text-3xl font-[400] mb-4 text-foreground dark:text-foreground">Ready to make your projects shine?</h3>
              <p className="text-muted-foreground dark:text-muted-foreground mb-8">
                Join the community of developers who showcase projects and get AI-powered insights on Shards.
              </p>
              <div className="flex flex-col gap-6 justify-center">
                <button className={`${accountBtnBase} hover:scale-105`}>
                  Create Your Account
                </button>
                <Link href="/shards/explore" className="text-foreground dark:text-foreground cursor-pointer py-1 rounded-lg font-medium group transition-colors">
