// app/(sidebar)/user/ai-toolkit/services/CodeBootstrapperModal.tsx
"use client";
...
export default function CodeBootstrapperModal({ onClose }: { onClose: () => void }) {
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  <label className="text-sm font-medium text-gray-300">Language/Framework</label>
                  <input
                    className="flex h-10 w-full rounded-md border border-gray-600 bg-gray-700 px-3 py-2 text-sm text-gray-200 placeholder:text-gray-500 focus:outline-none focus:ring-1 focus:ring-indigo-400/50 focus:border-indigo-400/50 hover:border-gray-500 transition-all"
                    placeholder="e.g., React, Python"
                  />
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-medium text-gray-300">Functionality</label>
                  <textarea
                    className="flex min-h-[80px] w-full rounded-md border border-gray-600 bg-gray-700 px-3 py-2 text-sm text-gray-200 placeholder:text-gray-500 focus:outline-none focus:ring-1 focus:ring-indigo-400/50 focus:border-indigo-400/50 hover:border-gray-500 transition-all"
              ...
              <div className="bg-gray-900/80 border border-gray-700 rounded-lg p-4 h-64 overflow-auto transition-all">
                <div className="prose prose-invert prose-sm max-w-none">
                  ...
                  <pre className="bg-gray-800 p-3 rounded overflow-x-auto">
                    <code>// Example React component...</code>
                  </pre>
                </div>
              </div>
            </div>
