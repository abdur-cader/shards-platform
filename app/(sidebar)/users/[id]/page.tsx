...
export default async function UserProfilePage({
  ...
  if (!userJson.ok) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center min-w-screen font-prompt text-2xl">
  ...
  return (
    <div className="flex h-screen min-w-screen max-w-screen-xl mx-auto ">
      {/* LEFT: profile info */}
      <aside className="w-72  border-r border-neutral-800 p-6 flex flex-col items-center sticky top-0 h-screen">
        <img
      ...
      <aside className="w-72 border-l border-neutral-800 p-6 overflow-y-auto">
        <h2 className="text-xl font-semibold mb-4">Recent Activity</h2>
        {/* TODO: replace this with real recent activity */}
        {[...Array(15)].map((_, i) => (
          <div
            key={i}
            className="mb-3 p-2 border rounded hover:bg-emerald-900 transition cursor-pointer"
          >
            <p className="text-sm">
