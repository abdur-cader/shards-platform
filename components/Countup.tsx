...
const Countup = () => {
  return (
          ...
          <h3 className="text-xl font-medium text-purple-50 mb-3">No-Cost Access</h3>
          <div className="flex items-baseline mb-2">
            <span className="text-3xl font-bold text-white mr-1">
              <CountUp end={10000} duration={5} enableScrollSpy scrollSpyOnce />
            </span>
          </div>
          <p className="text-purple-200 text-sm">
            free monthly AI credits.
          </p>
        </div>
  )
}
